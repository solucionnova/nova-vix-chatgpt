...
export function createRuntimeStub() {
  return {
    ...
    async open() { return { connection_id: '123e4567-e89b-42d3-a456-426614174000', resume_id: '123e4567-e89b-42d3-a456-426614174000', native_thread_id: null, vix_version: 'test-stock', modelCalls: 0 }; },
